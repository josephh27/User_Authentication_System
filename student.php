    ...
    <div class="landing-wrapper">
        ...
        <div class="landing-right">
            <div class="landing-right-inner">
                ...
                <form class="student-form" action="includes/student-login.inc.php" method="post">
                    <input type="text" class="login-input" name="student-id" placeholder="Student Number">
                    ...
                    <input type="text" class="login-input" name="student-password" placeholder="Password">
